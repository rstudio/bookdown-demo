...
On the above equation, Thresholds($τ_{k}$) are estimated empirically. They are not necessarily evenly spaced. Threshold structure varies across items. The relative distance between thresholds is estimated separately for each item.
...
summary(braun_data)
# Trim the data, we only need response matrix.
